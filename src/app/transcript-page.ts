...
const SCHOOLS = [
 ...
 const GRADES: Grade[] = [
    ...
    { id: 'COMP 4662', title: 'Intro to Software Development 2', grade: '', school: SCHOOLS[0], semester: SEMESTERS[0], year: 2017 },
    { id: 'COMP 4662', title: '.NET Windows Application Development in C#', grade: '', school: SCHOOLS[0], semester: SEMESTERS[0], year: 2017 },
    { id: 'COMP 4662', title: 'Advanced Web Applications with PHP', grade: '', school: SCHOOLS[0], semester: SEMESTERS[0], year: 2017 },
    ...
    { id: 'INFO 2315', title: 'Data Structure', grade: 'A-', school: SCHOOLS[1], semester: SEMESTERS[2], year: 2017 },
    ...
    { id: 'MATH 1140', title: 'Business Mathematics', grade: '', school: SCHOOLS[1], semester: SEMESTERS[0], year: 2017 },
    { id: 'MATH 1140', title: 'Object-Oriented Software Engineering', grade: '', school: SCHOOLS[1], semester: SEMESTERS[0], year: 2017 },
    { id: 'MATH 1140', title: 'Software Quality Assurance', grade: '', school: SCHOOLS[1], semester: SEMESTERS[0], year: 2017 },
];