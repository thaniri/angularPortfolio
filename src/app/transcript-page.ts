...
const SCHOOLS = [
 ...
 const GRADES: Grade[] = [
    ...
    { id: 'COMP 1451', title: 'Intro to Software Development 2', grade: '', school: SCHOOLS[0], semester: SEMESTERS[0], year: 2017 },
    { id: 'COMP 2614', title: '.NET Windows Application Development in C#', grade: '', school: SCHOOLS[0], semester: SEMESTERS[0], year: 2017 },
    { id: 'COMP 4669', title: 'Advanced Web Applications with PHP', grade: '', school: SCHOOLS[0], semester: SEMESTERS[0], year: 2017 },
